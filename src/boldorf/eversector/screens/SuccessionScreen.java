 ...
 * 
 */
public class SuccessionScreen extends ConfirmationScreen
        implements WindowScreen<PopupWindow>
{
    ...
    {
        player.getFaction().addNews(player + " has defeated our leader, "
                + leader + ", and has wrested control of the faction.");
