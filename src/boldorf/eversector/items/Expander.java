...
/**
 * An item designed to be included in resources that hold the information about
 * increasing the resource's capacity.
 */
public class Expander extends Item
{
    ...
    /**
     * Creates a new Expander with a name, description, value, and the default
     * expansion amount.
    ...
    /**
     * Creates a new Expander with a name, description, value, and expansion
     * amount.
     * @param name the name of the Expander
     * @param description the description of the Expander
     * @param value the value of the Expander
    ...
    /**
     * Copying constructor that creates another Expander identical to the
     * existing one.
     ...
     * @param properties the Properties object to use in the construction of the
     * Expander
     */
    public Expander(Properties properties)
    {
        super(properties);
        expansion = Math.abs(Utility.parseInt(
                properties.getProperty("expansion"), EXPANSION));
    }
    
    /**
     * Returns the amount that the expander causes a resource's capacity to
     * increase.
    ...
    public List<ColorString> define()
    {
        ...
        definition.add(2, new ColorString("Expansion: ")
