...
public class Star implements ColorStringObject
{
    ...
    private enum StarTemperature
    {
        ...
        StarTemperature(String name, Color color, boolean radiation, int minSize, int maxSize)
        {
            this.name = name;
            this.color = color;
    ...
    public Star(String name, Color color, char symbol, int mass, boolean radiation)
    {
        this.name = name;
        this.color = color;
        this.symbol = symbol;
