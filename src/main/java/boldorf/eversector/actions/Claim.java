...
public class Claim implements Action
{
    ...
    public String canExecute(Ship actor, Region region)
    {
        ...
        {
            return "You cannot afford the " + planet.getClaimCost() + " credit cost to claim territory on " +
                   planet + ".";
        }
        ...
        {
            return "There are currently ships of the " + region.getFaction() + " guarding the " +
